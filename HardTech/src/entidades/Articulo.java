...
//Para representar a la tabla Articulo
public class Articulo {
    private int id;
    private int categoriaId;
    private String categoriaNombre; //mostrado en un combo de formulario
    private String codigo;
    private String nombre;
    private double precioVenta;
    private int stock;
    private String descripcion;
    private String imagen; //para almacenar la ruta de imagen
    private boolean activo;

    
    //Constructores creados con el asistente de Java
    ...
    //Get and Set: para acceder a las variables privadas de esta clase pública
    public int getId() {
        return id;
    }
