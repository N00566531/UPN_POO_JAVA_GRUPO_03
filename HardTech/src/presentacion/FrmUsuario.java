...
public class FrmUsuario extends javax.swing.JInternalFrame {
  ...
  //Constructor
    ...
    private void cargarRoles(){
        //obtengo roles del método seleccionar
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        //valido cajas obligatorios y largos
        ...
        if (this.accion.equals("editar")){
            //Editar
            //obj de tipo Rol y obtengo el rol seleccionado del combo
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        //valido que al seleccione un registro
        if (tablaListado.getSelectedRowCount()==1){
            //variables para almacenar los valores del tablalistado
            ...
            //paso valores a la cajas que corresponden
            
            txtId.setText(id);
            //obj de tipo Rol e instancio; le envio al constructor el id y nombre
